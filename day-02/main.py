...
""" 
Jika kita memiliki angka yang banyak kita bisa menambahkan underscore,
manfaatnya hanya agar kita manusia bisa memvisualisasikannya dgn lebih mudah. 
"""
...
"""
Floor division dalam Python menggunakan operator "//" dan menghasilkan bilangan bulat terbesar yang kurang dari 
atau sama dengan hasil pembagian dua bilangan. Contoh: 10 // 3 menghasilkan 3. Floor division berguna untuk 
mendapatkan hasil pembagian dalam bentuk bilangan bulat tanpa memperhatikan sisa pembagian.
"""
print(8 // 3) # Output: 2

"""
Assignment operator shorthand pada Python adalah cara singkat untuk melakukan operasi pengisian nilai pada 
suatu variabel dengan menggunakan operasi matematika. Contoh-contoh termasuk += untuk penambahan, -= untuk 
pengurangan, *= untuk perkalian, /= untuk pembagian, %= untuk modulus, dan //= untuk floor division. Ini 
membantu membuat kode lebih ringkas.
"""
x = 5
...
"""
F-string (formatted string literal) pada Python adalah cara yang nyaman dan ekspresif untuk memformat string
dengan menyisipkan nilai variabel langsung ke dalam string menggunakan kurung kurawal {}. F-string 
diperkenalkan pada Python 3.6, memberikan sintaks yang jelas dan mudah dibaca serta memungkinkan penggunaan 
ekspresi Python di dalamnya untuk evaluasi nilai. F-string menyederhanakan proses formatting string 
dibandingkan dengan metode lama seperti % formatting atau str.format().
"""
name = "Handika"
age = 20
